...
Represents the validated input contract for SearchRequest operations.
...
| --- | --- |
| `SearchRequest(string Query, SearchMode Mode, int Limit, string Kind, string Path, string Project, Nullable<bool> IncludeTests, string FromFile, string FromProject, Nullable<int> TimeoutMs)` | Initializes a new instance. |
