...
Thumb thumb = new()
{
    Background = new DrawColor(210, 210, 210),
    BorderColor = new DrawColor(70, 70, 70),
...
| --- | --- | --- | --- |
| `Background` | `DrawColor` | `Control` | Gets or sets the fallback fill color rendered by the thumb. |
