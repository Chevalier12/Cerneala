# RepositoryFileReadResult Class
...
Represents the structured output contract for RepositoryFileReadResult operations.

```csharp
public sealed class RepositoryFileReadResult
```
...
| --- | --- |
| `RepositoryFileReadResult(string FilePath, string RepoRoot, string Language, int LineCount, long SizeBytes, string ContentHash, DateTimeOffset LastModifiedUtc, bool IsIndexed, string Content)` | Initializes a new instance. |
