...
Source: `UI/Detective/MotionTrace.cs`
...
foreach (MotionTraceEvent traceEvent in root.Detective.Motion.Trace.Events)
{
...
- `Cerneala.UI.Detective.MotionTraceEvent`
- `Cerneala.UI.Detective.MotionTraceEventKind`
- Source: `UI/Detective/MotionTrace.cs`
