# playground-scenarios Specification

## Purpose
Defines retained playground samples used to exercise controls, layout, text, input, invalidation diagnostics, and cached rendering inside the MonoGame host.
