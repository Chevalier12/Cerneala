...
description: Use when Claude must create or update Markdown API documentation from a source file, class, member, component, or natural-language instruction, especially WPF/Microsoft Learn-style class and member docs that must be written under docs/documentation/.
---
...
1. Resolve the documentation target.
   ...
   - Honor repository navigation rules, generated file rules, and local CLAUDE.md/AGENTS.md instructions before reading code.
