...
{
    [Fact]
    public void RegistryRoutesNotePaperToDedicatedShaderTechnique()
    {
        ...
        Assert.Equal("NotePaperFilter", kernel.Technique.Name);
    }
    ...
    public void HeightFieldPipelineRendersPaperHolesAndPreservesAlpha()
    {
        ...
        Assert.Equal("NotePaperFilter", registry.Effect.CurrentTechnique.Name);
        double difference = 0;
