...
{
    [Fact]
    public void RegistryRoutesPlasterToDedicatedShaderTechnique()
    {
        ...
        Assert.Equal("PlasterFilter", kernel.Technique.Name);
    }
    ...
    public void FivePassGuidedReliefRendersAndPreservesSourceAlpha()
    {
        ...
        Assert.Equal("PlasterFilter", registry.Effect.CurrentTechnique.Name);
        double difference = 0;
