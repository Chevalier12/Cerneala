...
{
    [Fact]
    public void RegistryRoutesWaterPaperToDedicatedShaderTechnique()
    {
        ...
        Assert.Equal("WaterPaperFilter", kernel.Technique.Name);
    }
    ...
    public void PigmentAndSubstratePipelineChangesColorAndPreservesAlpha()
    {
        ...
        Assert.Equal("WaterPaperFilter", registry.Effect.CurrentTechnique.Name);
        double difference = 0;
