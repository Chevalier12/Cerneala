...
{
    [Fact]
    public void RegistryRoutesGrainToDedicatedShaderTechnique()
    {
        ...
        Assert.Equal("GrainFilter", kernel.Technique.Name);
    }
    ...
    public void BooleanGrainShaderMatchesCpuAndPreservesAssociatedAlpha()
    {
        ...
        Assert.Equal("GrainFilter", registry.Effect.CurrentTechnique.Name);
