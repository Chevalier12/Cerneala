...
public sealed class PrismRetainedCommandContractTests
{
    ...
    [Fact]
    public void BuilderEmitsClipScopeLocalAndChildrenInCanonicalOrder()
    {
    ...
    [Fact]
    public void BuilderNestsScopesAndPreservesTransformScaleVersionsAndEffectiveOpacity()
    {
    ...
    [Fact]
    public void PresenceExitingChildrenRemainInsideTheOwningScopeAfterLiveChildren()
    {
