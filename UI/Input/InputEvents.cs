...
public static class InputEvents
{
    ...
    public static readonly RoutedEvent PreviewStylusDownEvent = Register("PreviewStylusDown", RoutingStrategy.Tunnel, typeof(StylusEventArgs));
    public static readonly RoutedEvent StylusDownEvent = Register("StylusDown", RoutingStrategy.Bubble, typeof(StylusEventArgs));
    public static readonly RoutedEvent PreviewStylusUpEvent = Register("PreviewStylusUp", RoutingStrategy.Tunnel, typeof(StylusEventArgs));
    public static readonly RoutedEvent StylusUpEvent = Register("StylusUp", RoutingStrategy.Bubble, typeof(StylusEventArgs));
    public static readonly RoutedEvent PreviewStylusMoveEvent = Register("PreviewStylusMove", RoutingStrategy.Tunnel, typeof(StylusEventArgs));
    public static readonly RoutedEvent StylusMoveEvent = Register("StylusMove", RoutingStrategy.Bubble, typeof(StylusEventArgs));
    public static readonly RoutedEvent PreviewStylusInAirMoveEvent = Register("PreviewStylusInAirMove", RoutingStrategy.Tunnel, typeof(StylusEventArgs));
    public static readonly RoutedEvent StylusInAirMoveEvent = Register("StylusInAirMove", RoutingStrategy.Bubble, typeof(StylusEventArgs));
    public static readonly RoutedEvent StylusEnterEvent = Register("StylusEnter", RoutingStrategy.Direct, typeof(StylusEventArgs));
    public static readonly RoutedEvent StylusLeaveEvent = Register("StylusLeave", RoutingStrategy.Direct, typeof(StylusEventArgs));
    public static readonly RoutedEvent PreviewStylusInRangeEvent = Register("PreviewStylusInRange", RoutingStrategy.Tunnel, typeof(StylusEventArgs));
    public static readonly RoutedEvent StylusInRangeEvent = Register("StylusInRange", RoutingStrategy.Bubble, typeof(StylusEventArgs));
    public static readonly RoutedEvent PreviewStylusOutOfRangeEvent = Register("PreviewStylusOutOfRange", RoutingStrategy.Tunnel, typeof(StylusEventArgs));
    public static readonly RoutedEvent StylusOutOfRangeEvent = Register("StylusOutOfRange", RoutingStrategy.Bubble, typeof(StylusEventArgs));
    public static readonly RoutedEvent PreviewStylusSystemGestureEvent = Register("PreviewStylusSystemGesture", RoutingStrategy.Tunnel, typeof(StylusEventArgs));
    public static readonly RoutedEvent StylusSystemGestureEvent = Register("StylusSystemGesture", RoutingStrategy.Bubble, typeof(StylusEventArgs));
    public static readonly RoutedEvent GotStylusCaptureEvent = Register("GotStylusCapture", RoutingStrategy.Bubble, typeof(StylusEventArgs));
    public static readonly RoutedEvent LostStylusCaptureEvent = Register("LostStylusCapture", RoutingStrategy.Bubble, typeof(StylusEventArgs));
    public static readonly RoutedEvent PreviewStylusButtonDownEvent = Register("PreviewStylusButtonDown", RoutingStrategy.Tunnel, typeof(StylusEventArgs));
    public static readonly RoutedEvent StylusButtonDownEvent = Register("StylusButtonDown", RoutingStrategy.Bubble, typeof(StylusEventArgs));
    public static readonly RoutedEvent PreviewStylusButtonUpEvent = Register("PreviewStylusButtonUp", RoutingStrategy.Tunnel, typeof(StylusEventArgs));
    public static readonly RoutedEvent StylusButtonUpEvent = Register("StylusButtonUp", RoutingStrategy.Bubble, typeof(StylusEventArgs));

    public static readonly RoutedEvent PreviewTouchDownEvent = Register("PreviewTouchDown", RoutingStrategy.Tunnel, typeof(TouchEventArgs));
    public static readonly RoutedEvent TouchDownEvent = Register("TouchDown", RoutingStrategy.Bubble, typeof(TouchEventArgs));
    public static readonly RoutedEvent PreviewTouchMoveEvent = Register("PreviewTouchMove", RoutingStrategy.Tunnel, typeof(TouchEventArgs));
    public static readonly RoutedEvent TouchMoveEvent = Register("TouchMove", RoutingStrategy.Bubble, typeof(TouchEventArgs));
    public static readonly RoutedEvent PreviewTouchUpEvent = Register("PreviewTouchUp", RoutingStrategy.Tunnel, typeof(TouchEventArgs));
    public static readonly RoutedEvent TouchUpEvent = Register("TouchUp", RoutingStrategy.Bubble, typeof(TouchEventArgs));
    public static readonly RoutedEvent TouchEnterEvent = Register("TouchEnter", RoutingStrategy.Direct, typeof(TouchEventArgs));
    public static readonly RoutedEvent TouchLeaveEvent = Register("TouchLeave", RoutingStrategy.Direct, typeof(TouchEventArgs));
    public static readonly RoutedEvent GotTouchCaptureEvent = Register("GotTouchCapture", RoutingStrategy.Bubble, typeof(TouchEventArgs));
    public static readonly RoutedEvent LostTouchCaptureEvent = Register("LostTouchCapture", RoutingStrategy.Bubble, typeof(TouchEventArgs));
    ...
    public static readonly RoutedEvent PreviewDragEnterEvent = Register("PreviewDragEnter", RoutingStrategy.Tunnel, typeof(DragEventArgs));
    public static readonly RoutedEvent DragEnterEvent = Register("DragEnter", RoutingStrategy.Bubble, typeof(DragEventArgs));
    public static readonly RoutedEvent PreviewDragOverEvent = Register("PreviewDragOver", RoutingStrategy.Tunnel, typeof(DragEventArgs));
    public static readonly RoutedEvent DragOverEvent = Register("DragOver", RoutingStrategy.Bubble, typeof(DragEventArgs));
    public static readonly RoutedEvent PreviewDragLeaveEvent = Register("PreviewDragLeave", RoutingStrategy.Tunnel, typeof(DragEventArgs));
    public static readonly RoutedEvent DragLeaveEvent = Register("DragLeave", RoutingStrategy.Bubble, typeof(DragEventArgs));
    public static readonly RoutedEvent PreviewDropEvent = Register("PreviewDrop", RoutingStrategy.Tunnel, typeof(DragEventArgs));
    public static readonly RoutedEvent DropEvent = Register("Drop", RoutingStrategy.Bubble, typeof(DragEventArgs));
