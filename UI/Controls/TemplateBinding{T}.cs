...
{
    private protected TemplateBinding(UiProperty sourceProperty, UIElement target, UiProperty targetProperty)
    {
    ...
    public static TemplateBinding Create(UiProperty sourceProperty, UIElement target, UiProperty targetProperty)
    {
        ...
        return (TemplateBinding)Activator.CreateInstance(bindingType, sourceProperty, target, targetProperty)!;
    }
}
...
public sealed class TemplateBinding<T> : TemplateBinding
{
    ...
    public TemplateBinding(UiProperty<T> sourceProperty, UIElement target, UiProperty<T> targetProperty)
        : base(sourceProperty, target, targetProperty)
    {
    ...
    {
        Target.SetValue(TargetProperty, control.GetValue(SourceProperty), UiPropertyValueSource.TemplateBinding);
    }
}
